      ...
      <View style={styles.guideTopinfo}>
        <View style={styles.guideInfo}>
          <Text style={styles.guideInfoTitle}>Product One</Text>
            <Text style={styles.guideInfoPara}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolore, voluptatem officiis! Quidem suscipit provident nisi eligendi atque architecto animi ab vitae quia, quo sunt mollitia, ipsa recusandae dolore, amet autem!</Text>
        </View>
